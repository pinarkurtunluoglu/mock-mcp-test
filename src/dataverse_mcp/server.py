...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "- **CRITICAL — Category vs Product**: Names like 'Buğday', 'Mısır', 'Soya Küspesi', 'Nohut', 'Ayçiçeği' are CATEGORY names (Level 3), NOT product names. "
        "ALWAYS filter these on `mserp_etgproductlevel03name`, NEVER on `mserp_itemname`.\n"
